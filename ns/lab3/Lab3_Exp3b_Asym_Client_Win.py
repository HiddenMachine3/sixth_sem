...
HOST = '172.18.31.55'  # Change it to WSL IP address by using ifconfig cmd
PORT = 65432

# Load the server's public key from public.pem
with open("public.pem", "rb") as key_file:
    public_key = serialization.load_pem_public_key(key_file.read())
# print(help(serialization.load_pem_private_key))
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
    ...
    print("Received decrypted data", server_response)